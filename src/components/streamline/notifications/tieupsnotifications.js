...
const tieupsnotifications = (props) => {     
            ...
            <li className={classshared.notification_item}>
                ...
                <div className={classshared.stream_card_flex}>
                    <span ><Button btntype={ButtonType.btn_purple_font_1_bold}
                        buttontype="button"
                        clicked={props.accepttieupsrequest}
                    >{ButtonText.accept}
                    </Button></span>
                    <span className={classshared.margin_l_m}><Button btntype={ButtonType.btn_btn_outline_grey}
                        buttontype="button" clicked={props.rejecttieupsrequest}>{ButtonText.reject}</Button></span>
                </div>
            </li>
        </React.Fragment>
    )
}
export default React.memo(tieupsnotifications);