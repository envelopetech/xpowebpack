...
import Largestbeneficiariesitems from './largestbeneficiariesitems';
...
class largestbeneficiaries extends Component {
    constructor(props) {
        super(props);        
        this.state={
            userdata:null,
        ...
        if(finalist !== null)
        {
            if(finalist.length > 0)
            {
                ...
                data=  finalist.map((item,i) => {                
                        ...
                        let items=  <Largestbeneficiariesitems id={item.id}
...
export default  largestbeneficiaries;