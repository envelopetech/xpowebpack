...
const largestbeneficiariesitems = (props) => {    
            ...
            <div className={classshared.tieup_profile_content}> 
                ...
                <div className={classshared.inquiry_box_upper}>
                    <div className={classshared.text_14}>
                        ...
                        <div className={classshared.text_color_pink_font_1_bold.join(' ')}>24</div>
                    </div>  
                    <div className={classshared.text_14.join(' ')}>
                        <div>Business Received</div>
                        <div className={classshared.text_color_pink_font_1_bold.join(' ')}>{props.currency_name} 17,250</div>
                    </div>    
                </div>            
            </div>
            </div>
...
export default React.memo(largestbeneficiariesitems);