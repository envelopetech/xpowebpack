...
class newlyjoineduser extends Component {
    constructor(props) {
        super(props);        
        this.state={
            userdata:null,
        ...
        if(finalist !== null)
        {
            if(finalist.length > 0)
            {
                ...
                data=  finalist.map((item,i) => {                
                        ...
                        let items=  <TieupsItems id={item.id}
                        ...
                        tieups_just_requested={this.state.tieups_just_requ9ested}
...
export default  newlyjoineduser;