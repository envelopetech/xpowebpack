...
import {ButtonType,ICONS,titleheading, ButtonText} from '../../../shared/utility';


const aboutmedesignationedit = ( props ) => {    
    return(
        <React.Fragment>
                    ...
                    <div className={classshared.simple_form}> 
                        ...
                        <div className={classshared.form_group}>
                            <input className={classshared.input_box} required={props.required} value={props.designationvalue} onChange={props.ondesignationchanged}></input>
                            <label className={classshared.form_label}>{titleheading.designation}</label>
                        </div> 
                        <div className={classshared.form_group}>
                            <input className={classshared.input_box} required={props.required} value={props.companyvalue} onChange={props.oncompanychanged}></input>
                            <label className={classshared.form_label}>{titleheading.comapny}</label>
                        </div> 
                    </div> 
...
export default aboutmedesignationedit;